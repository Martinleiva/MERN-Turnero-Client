            ...
            <nav className="navbar navbar-expand-lg navbar-dark bg-success">
                ...
                <div className="collapse navbar-collapse" id="navbarColor01">
                    <ul className="navbar-nav mr-auto">
                        ...
                        <li className="nav-item">
                            <NavLink exact to={'/my-establishments'} className="nav-link" activeClassName="nav-link active">
                                Complejos
                            </NavLink>
                        </li>
                        <li className="nav-item">
                            <NavLink exact to={'/my-account-owner'} className="nav-link" activeClassName="nav-link active">
                                Mi cuenta
                            </NavLink>
                        </li>
